...
class ModelOptimizerDialog(QDialog):
    ...
    def initUI(self):
        ...
        # Tabs для розділення параметрів compile і fit
    ...
    def setup_compile_tab(self):
        ...
        #optimizer_layout.addWidget(self.use_optimizer)
        ...
        #self.loss_combo.setEnabled(False)

        #loss_layout.addWidget(self.use_loss)
        ...
        #self.use_metrics = QCheckBox("Обрати метрики")
        #self.use_metrics.toggled.connect(self.toggle_metrics)
    ...
    def collect_parameters(self):
        ...
        # Якщо жодних параметрів не обрано, задамо стандартні
    ...
    def start_optimization(self):
        ...
        if self.params_to_tune is None:
            return
        # Перемикаємося на вкладку з результатами
        ...
        # Запускаємо оптимізацію у окремому потоці
