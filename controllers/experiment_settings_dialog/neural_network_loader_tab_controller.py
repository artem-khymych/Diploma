...
class NeuralNetworkLoaderTabController(TabController):
    ...
    def connect_signals(self):
        ...
        self.view.model_type_combo.currentIndexChanged.connect(self.on_model_type_changed)
    ...
    def on_model_type_changed(self, index):
        ...
        if index == 0:  # Keras (.h5)
            ...
            self.view.file_path_label.setText("Файл моделі:")
    ...
    def on_browse_clicked(self):
        ...
        model_type_index = self.view.model_type_combo.currentIndex()
    ...
    def on_load_clicked(self):
        ...
        try:
            ...
            #TODO send data to nn_input_data of the experiment after loading
    ...
    def update_model_from_view(self):
        self.experiment.load_type = self.view.model_type_combo.currentText()
