...
class NeuralNetworkLoaderTabWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.model_type_combo.addItems(["Keras (.h5)", "TensorFlow SavedModel",
                                        "JSON + Weights"])
        ...
        tasks = ModelTaskRegistry().get_tasks_for_model(model_type=NNModelType.GENERIC.value)
        ...
        file_layout.addWidget(self.model_type_combo, 0, 1, 1, 2)
        ...
        file_layout.addWidget(QLabel("Задача:"), 4, 1)
        file_layout.addWidget(self.model_task_combo, 4, 2)
